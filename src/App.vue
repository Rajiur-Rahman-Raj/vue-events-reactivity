<script setup>
    import { ref } from 'vue';
    const defaultThumb = ref('https://plus.unsplash.com/premium_photo-1666963323736-5ee1c16ef19d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1yZWxhdGVkfDE2fHx8ZW58MHx8fHx8&auto=format&fit=crop&w=1024&q=60')
    const images = [
        {
    ...
    <section class="container mx-auto flex items-center flex-col">
        ...
        <div class="">
            <div class="flex space-x-2">
                <img class="cursor-pointer" v-for="image in images" :key="image.thumb" :src="image.thumb" alt="image.thumb" @click="changeImage(image.full)">
            </div>
            <div class="mt-10">
                <img class="cursor-pointer w-full" :src="defaultThumb" alt="">
            </div>
        </div>
    </section>
</template>
